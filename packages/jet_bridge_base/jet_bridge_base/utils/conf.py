...
def get_request_conf(request):
    ...
    return {
        ...
        'rls_type': bridge_settings.get('database_rls_type'),
        'rls_sso': bridge_settings.get('database_rls_sso'),
        'rls_user_property': bridge_settings.get('database_rls_user_property'),
